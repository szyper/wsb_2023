namespace _4_1_dziedziczenie_ex_1
{
  ...
  internal class Program
  {
    ...
    {
      Console.Write("Podaj imię sudenta:");
      string name = Console.ReadLine();
      ...
      Console.Write("Podaj numer indeksu studena:");
      ...
      else
      {
        ...
        foreach (Person user in users)
        {
          if (user is Student)
          {
            ...
            Console.WriteLine($"Imię i nazwisko: {user.Name} {user.Surname}");
            Console.WriteLine($"Data urodzenia: {user.DateOfBirth.ToShortDateString()}");
            Console.WriteLine($"Numer indeksu: {((Student)user).StudentNumber}");
          }
      ...
      else
      {
        ...
        foreach (Person user in users)
        {
          if (user is Teacher)
          {
            ...
            Console.WriteLine($"Imię i nazwisko: {user.Name} {user.Surname}");
            Console.WriteLine($"Data urodzenia: {user.DateOfBirth.ToShortDateString()}");
            Console.WriteLine($"Przedmioty: {string.Join(", ", ((Teacher)user).Subjects)}");
          }
